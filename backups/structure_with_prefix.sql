CREATE TABLE IF NOT EXISTS `densusreport_bot_user` (
...
CREATE TABLE IF NOT EXISTS `densusreport_bot_chat` (
...
CREATE TABLE IF NOT EXISTS `densusreport_bot_user_chat` (
  `user_id` bigint COMMENT 'Unique user identifier',
  `chat_id` bigint COMMENT 'Unique user or chat identifier',

  PRIMARY KEY (`user_id`, `chat_id`),

  FOREIGN KEY (`user_id`) REFERENCES `densusreport_bot_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`chat_id`) REFERENCES `densusreport_bot_chat` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `densusreport_bot_inline_query` (
  ...
  FOREIGN KEY (`user_id`) REFERENCES `densusreport_bot_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `densusreport_bot_chosen_inline_result` (
...
CREATE TABLE IF NOT EXISTS `densusreport_bot_message` (
  ...
  FOREIGN KEY (`user_id`) REFERENCES `densusreport_bot_user` (`id`),
  FOREIGN KEY (`chat_id`) REFERENCES `densusreport_bot_chat` (`id`),
  FOREIGN KEY (`forward_from`) REFERENCES `densusreport_bot_user` (`id`),
  FOREIGN KEY (`forward_from_chat`) REFERENCES `densusreport_bot_chat` (`id`),
  FOREIGN KEY (`reply_to_chat`, `reply_to_message`) REFERENCES `densusreport_bot_message` (`chat_id`, `id`),
  FOREIGN KEY (`via_bot`) REFERENCES `densusreport_bot_user` (`id`),
  FOREIGN KEY (`left_chat_member`) REFERENCES `densusreport_bot_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `densusreport_bot_edited_message` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
  `chat_id` bigint COMMENT 'Unique chat identifier',
  ...
  FOREIGN KEY (`chat_id`) REFERENCES `densusreport_bot_chat` (`id`),
  FOREIGN KEY (`chat_id`, `message_id`) REFERENCES `densusreport_bot_message` (`chat_id`, `id`),
  FOREIGN KEY (`user_id`) REFERENCES `densusreport_bot_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `densusreport_bot_callback_query` (
  `id` bigint UNSIGNED COMMENT 'Unique identifier for this query',
  `user_id` bigint NULL COMMENT 'Unique user identifier',
...
CREATE TABLE IF NOT EXISTS `densusreport_bot_shipping_query` (
...
CREATE TABLE IF NOT EXISTS `densusreport_bot_pre_checkout_query` (
  `id` bigint UNSIGNED COMMENT 'Unique query identifier',
  `user_id` bigint COMMENT 'User who sent the query',
...
CREATE TABLE IF NOT EXISTS `densusreport_bot_poll` (
...
CREATE TABLE IF NOT EXISTS `densusreport_bot_poll_answer` (
  ...
  FOREIGN KEY (`poll_id`) REFERENCES `densusreport_bot_poll` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `densusreport_bot_chat_member_updated` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
...
CREATE TABLE IF NOT EXISTS `densusreport_bot_chat_join_request` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
...
CREATE TABLE IF NOT EXISTS `densusreport_bot_telegram_update` (
  ...
  FOREIGN KEY (`chat_id`, `message_id`) REFERENCES `densusreport_bot_message` (`chat_id`, `id`),
  FOREIGN KEY (`edited_message_id`) REFERENCES `densusreport_bot_edited_message` (`id`),
  FOREIGN KEY (`chat_id`, `channel_post_id`) REFERENCES `densusreport_bot_message` (`chat_id`, `id`),
  FOREIGN KEY (`edited_channel_post_id`) REFERENCES `densusreport_bot_edited_message` (`id`),
  FOREIGN KEY (`inline_query_id`) REFERENCES `densusreport_bot_inline_query` (`id`),
  FOREIGN KEY (`chosen_inline_result_id`) REFERENCES `densusreport_bot_chosen_inline_result` (`id`),
  FOREIGN KEY (`callback_query_id`) REFERENCES `densusreport_bot_callback_query` (`id`),
  FOREIGN KEY (`shipping_query_id`) REFERENCES `densusreport_bot_shipping_query` (`id`),
  FOREIGN KEY (`pre_checkout_query_id`) REFERENCES `densusreport_bot_pre_checkout_query` (`id`),
  FOREIGN KEY (`poll_id`) REFERENCES `densusreport_bot_poll` (`id`),
  FOREIGN KEY (`poll_answer_poll_id`) REFERENCES `densusreport_bot_poll_answer` (`poll_id`),
  FOREIGN KEY (`my_chat_member_updated_id`) REFERENCES `densusreport_bot_chat_member_updated` (`id`),
  FOREIGN KEY (`chat_member_updated_id`) REFERENCES `densusreport_bot_chat_member_updated` (`id`),
  FOREIGN KEY (`chat_join_request_id`) REFERENCES `densusreport_bot_chat_join_request` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `densusreport_bot_conversation` (
...
CREATE TABLE IF NOT EXISTS `densusreport_bot_request_limiter` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
